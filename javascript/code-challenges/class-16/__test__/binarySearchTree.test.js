...
//   })
  ...
  it("find max value",()=>{
    ...
    nodeTree.add(14)
    nodeTree.add(90)
    // console.log('=======>>>>',nodeTree.findMax());
    expect(nodeTree.findMax()).toBe(90);
  })

  it("find max value",()=>{
    let valueCollection=[ 9,3,14,11,57,,72,62,31,20]
    ...
    searchTree.add(72)
    searchTree.add(14)
    // console.log('=======>>>>',searchTree.findMax());
    expect(searchTree.findMax()).toBe(72);
  })
});